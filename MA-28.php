                ...
                <div class="col-lg-7 col-12 mt-50 order-lg-1">
                    ...
                    <div class="product-popup-container product-gallery">
                        <div class="product-item">
                            <a href="assets/images/ma_28_a.jpg"><img src="assets/images/ma_28_a.jpg" class="img-fluid" alt="" /></a>
                        </div>
                        <!-- <div class="product-item">
                ...
                <div class="col-lg-5 col-12 gallery-margin-1 order-lg-2">
                    ...
                    <div class="product-summery position-relative">
                        <div class="product-head">
                            <h1 class="product-title">MA-28 <br> Radiometer</h1>
                        ...
                        <p>Capable of air and bone conduction measurements, the MA 28 is the ideal device for hearing screening — whether you are in the clinic or the field. Take the device anywhere you need it. The MA 28 is portable and therefore designed to be lightweight and sturdy. Its integrated handle and storage compartment make transportation even easier while protecting all of your accessories necessary for hearing testing. </p>       
                        <p>Select multiple stimulus options by the touch of a button and benefit from the automated Hughson-Westlake test. The MA 28 offers signal intensities ranging from -10 dBHL to 110 dBHL. Benefit from the bone conduction function as well as the masking function to ensure accurate test results.</p>   
                    </div>
                        ...
                        <div role="tabpanel" id="description" class="product_tab_content fade active show">
                            <div class="product_description_wrap mt-20">
                                <div class="product_desc">
                                    ...
                                    <p>Adjusting frequency and hearing levels gets easier and more comfortable than ever with the large LED color display as well as the classical control knobs. Operating the MA 28 feels always fast and intuitive.</p>    
                                </div>
                                <div class="pro__feature mt-20">
                                    ...
                                    <ul class="feature_list">
                                        ...
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Compact and portable with integrated handle and compartment</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Large color display for easy operation</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Automated Hughson-Westlake included</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Internal database stores 500 patients (3500 tests)</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Optional thermal printer</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Optional MAICO Sessions PC software connectable with OtoAccess® or Noah patient database for easy data management</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
