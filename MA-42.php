                ...
                <div class="col-lg-7 col-12 mt-50 order-lg-1">
                    ...
                    <div class="product-popup-container product-gallery">
                        <div class="product-item">
                            <a href="assets/images/ma_42.jpg"><img src="assets/images/ma_42.jpg" class="img-fluid" alt="" /></a>
                        </div>
                        <!-- <div class="product-item">
                ...
                <div class="col-lg-5 col-12 gallery-margin-1 order-lg-2">
                    ...
                    <div class="product-summery position-relative">
                        <div class="product-head">
                            <h1 class="product-title">MA-42 <br> Radiometer</h1>
                            ...
                            <div class="product_description_wrap mt-20">
                                ...
                                <div class="pro__feature mt-20">
                                    ...
                                    <ul class="feature_list">
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Air, bone and speech 2 channel audiometer with advanced diagnostic test functions</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Mixing signals and channels independently</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Connection of one or two AC transducers, BC and free-field testing</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Optional high frequency audiometry up to 16,000 Hz</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Full colorful display with simple screen design</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Small footprint for ease of portability</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Easy access to talk forward, talk back and monitor functions</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>License management center for easy upgrades</a></li>
                                        ...
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Direct printout of the results, store report as PDF or quickly transfer to MAICO Sessions PC software</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
