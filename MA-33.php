                ...
                <div class="col-lg-7 col-12 mt-50 order-lg-1">
                    ...
                    <div class="product-popup-container product-gallery">
                        <div class="product-item">
                            <a href="assets/images/MA-33.jpg"><img src="assets/images/MA-33.jpg" class="img-fluid" alt="" /></a>
                        </div>
                        <!-- <div class="product-item">
                ...
                <div class="col-lg-5 col-12 gallery-margin-1 order-lg-2">
                    ...
                    <div class="product-summery position-relative">
                        <div class="product-head">
                            <h1 class="product-title">MA-33 <br> Radiometer</h1>
                        ...
                        <p>The MA 33 is our small, fast and flexible PC audiometer for every occasion. The operation via USB connection to your PC or notebook is very easy and the MA 33 allows numerous possibilities to highly adopt the settings to your personal preferences and needs. The software offers various fast and reliable audiometry methods.</p>   
                        <p>Whether you are an ENT doctor, general practitioner, audiologist, pediatrician or work in occupational health, the various test methods make the MA 33 the ideal device for you.</p>
                    </div>
                            ...
                            <div class="product_description_wrap mt-20">
                                ...
                                <div class="pro__feature mt-20">
                                    ...
                                    <ul class="feature_list">
                                        ...
                                        <li><a href="#"><i class="z mdi zmdi-play-circle"></i>Intuitive handling of the clearly presented user interface</a></li>
