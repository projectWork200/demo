...
?>
    ...
    <div class="product-area product-details-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-12 mt-50 order-lg-1">
                    <!-- Product Zoom Image start -->
                    <div class="product-popup-container product-gallery">
                        <div class="product-item">
                            <a href="assets/images/PILOT-test.jpg"><img src="assets/images/PILOT-test.jpg" class="img-fluid" alt="" /></a>
                        </div>
                        <!-- <div class="product-item">
                        ...
                        <div class="product-item">
                            <a href="assets/images/product/product-details/product-details-3.jpg"><img src="assets/images/product/product-details/product-details-3.jpg" class="img-fluid" alt="" /></a>
                        </div>
                        <div class="product-item">
                            <a href="assets/images/product/product-details/product-details-4.jpg"><img src="assets/images/product/product-details/product-details-4.jpg" class="img-fluid" alt="" /></a>
                        </div> -->
                    </div>
                    <!-- Product Zoom Image End -->
                </div>
                <div class="col-lg-5 col-12 gallery-margin-1 order-lg-2">
                    <!-- Product Summery Start -->
                    <div class="product-summery position-relative">
                        <div class="product-head">
                            <h1 class="product-title">PILOT TEST <br> Radiometer</h1>
                        ...
                        <p>The small patient purchases a “pilot license” in a playful way. Connected to the game is a hearing test, aiming to examine hearing and speech comprehension. Furthermore, the test shows the kid’s ability to put things heard into action. Thus, severe hearing impairments may be discovered in time, especially with preschoolers.</p>    
                        <p>After completing the Pilot Hearing Test each kid is rewarded with a sticker and leaves the premises a proud pilot.</p>    
                    </div>
            ...
            <div class="row gallery-margin-2">
                        ...
                        <div role="tabpanel" id="description" class="product_tab_content fade active show">
                            <div class="product_description_wrap mt-20">
                                <div class="product_desc">
                                    ...
                                    <p>For children of school age, the device provides an inbuilt tone audiometer with eight frequencies to enable the exact determination of the auditory threshold. Thus, the device offers the perfect testing method for each age. The tone audiometry may be connected to the software used by the office. </p>    
                                </div>
                                <div class="pro__feature mt-20">
                                    <h2 class="last-title mb-20">Features</h2>
                                    <ul class="feature_list">
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Audiometer with air conduction</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Pilot-Hearing test for children</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>SISI, Stenger and automatic Hughson-Westlake tests available</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Intuitive handling of the clearly presented user interface</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Operate at your convenience with your mouse or keyboard</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Small, fast, flexible and highly mobile</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Display and store your results in one second</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Includes MAICO Patient Database</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Easily expandable to future developments</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="review_address_inner mt-20">
                                ...
                                <div class="pro_review">
                                    ...
                                    <div class="review_details">
                                        ...
                                        <h6>How does our Pilot Hearing Test work?</h6>
                                        <p>The child is prompted to indicated different items on a display: “Show me the ice!” Meanwhile the tasks’ level of difficulty is increased gradually, by automatically reducing the volume of the spoken requests bit by bit. The test range varies from 70 dBHL in the beginning to 25 dBHL..</p>
                                    </div>
                                </div>
                                <!-- End Single Review -->
                                <!-- Start Single Review -->
                    ...
                    <div class="product-details-home2 mt-45 mb-15">
                        ...
                        <div class="product-carousel-home2 slick-custom slick-custom-default nav-top">
                            <div class="product-row">
                                ...
                                <div class="product-thumb">
                                    <a href="product-details.php">
                                        <img src="assets/images/ma_1.jpg" alt="" class="img-fluid">
                                    </a>
                                    <div class="box-label">
                                ...
                                <div class="product-caption">
                                    <div class="product-name">
                                        <a href="product-details.php" style=" text-align: center;">MA 1 <br> Radiometer</a>
                                    </div>
                                    <div class="rating">
                                        <span class="yellow"><i class="fa fa-star"></i></span>
                                        <span class="yellow"><i class="fa fa-star"></i></span>
                            ...
                            <div class="item-product">
                                <div class="product-thumb">
                                    <a href="product-details.html">
                                        <img src="assets/images/ma_25_a.jpg" alt="" class="img-fluid">
                                    </a>
                                    <div class="box-label">
                                        <div class="label-product-new">
                                            <span>New</span>
                                ...
                                <div class="product-caption">
                                    <div class="product-name">
                                        <a href="product-details.html" style=" text-align: center;">MA 25 <br> Radiometer</a>
                                    </div>
                                    <div class="rating">
                                        <span class="yellow"><i class="fa fa-star"></i></span>
                                        <span class="yellow"><i class="fa fa-star"></i></span>
                            ...
                            <div class="item-product">
                                <div class="product-thumb">
                                    <a href="product-details.html">
                                        <img src="assets/images/ma_28.jpg" alt="" class="img-fluid" >
                                    </a>
                                    <div class="action-link">
                                        <a class="quick-view same-link" href="#" title="Quick view" data-toggle="modal" data-target="#modal_box" data-original-title="quick view"><i class="zmdi zmdi-eye zmdi-hc-fw"></i></a>
                                        <a class="compare-add same-link" href="compare.html" title="Add to compare"><i class="zmdi zmdi-refresh-alt"></i></a>
                                ...
                                <div class="product-caption">
                                    <div class="product-name">
                                        <a href="#" style=" text-align: center;">MA 28 <br> Radiometer</a>
                                    </div>
                                    <div class="rating">
                                        <span class="yellow"><i class="fa fa-star"></i></span>
                                        <span class="yellow"><i class="fa fa-star"></i></span>
                            ...
                            <div class="item-product">
                                <div class="product-thumb">
                                    <a href="product-details.html">
                                        <img src="assets/images/ufrco7.jpg" alt="" class="img-fluid">
                                    </a>
                                    <div class="box-label">
                                        <div class="label-product-new">
                                            <span>New</span>
                                ...
                                <div class="product-caption">
                                    <div class="product-name">
                                        <a href="product-details.php" style=" text-align: center;">MA 33 <br> Radiometer </a>
                                    </div>
                                    <div class="rating">
                                        <span class="yellow"><i class="fa fa-star"></i></span>
                                        <span class="yellow"><i class="fa fa-star"></i></span>
