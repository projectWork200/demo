                ...
                <div class="col-lg-7 col-12 mt-50 order-lg-1">
                    ...
                    <div class="product-popup-container product-gallery">
                        <div class="product-item">
                            <a href="assets/images/ma_1.jpg"><img src="assets/images/ma_1.jpg" class="img-fluid" alt="" /></a>
                        </div>
                        <!-- <div class="product-item">
                ...
                <div class="col-lg-5 col-12 gallery-margin-1 order-lg-2">
                    ...
                    <div class="product-summery position-relative">
                        <div class="product-head">
                            <h1 class="product-title">MA-1 <br> Radiometer</h1>
                        ...
                        <p>A Screening Audiometer That Fits Right into Your Hand</p>       
                        <p>The MA 1 audiometer is MAICO’s smallest solution for fast hearing screening. Just like a remote control, the device fits into the palm of your hand and is very lightweight. Operate the device with only one hand and benefit from its fast screening capabilities — ideal for hearing aid dispensers.</p>
                        <p>To save power, the device turns off automatically when inactive for 30 seconds. Press any  button to turn it on again. The MA 1 is powered by 2 AA alkaline batteries and is configured with a dedicated DD45 headset.</p>
                    </div>
                        ...
                        <div role="tabpanel" id="description" class="product_tab_content fade active show">
                            <div class="product_description_wrap mt-20">
                                <div class="product_desc">
                                    ...
                                    <p>One-Handed Hearing Screening <br> The handheld audiometer MA 1 offers pure tone audiometry for fast screening purposes. Adjust and present frequencies and intensities quickly by one hand operation. The MA 1 audiometer delivers a pure tone signal to one ear at a time. The stimulus range is adjustable in 5 dB  steps from 15 to 50 dBHL. The test frequencies range from 500 to 4000 Hz.</p>    
                                </div>
                                <div class="pro__feature mt-20">
                                    <h2 class="last-title mb-20">Features</h2>
                                    <ul class="feature_list">
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Portable handheld screening audiometer</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Pure tone signal from 15 to 50 dBHL</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Test frequencies of 500, 1000, 2000 and 4000 Hz</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Powered by batteries</a></li>
                                        <li><a href="#"><i class="zmdi zmdi-play-circle"></i>Comes with DD45 headset</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
