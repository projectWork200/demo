                    ...
                    <div class="offcanvas_menu_wrapper">
                        ...
                        <div class="offcanvas_menu_cover text-left">
                            <ul class="offcanvas_main_menu">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="menu-item-has-children">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li><a href="MA-1.php">MA 1</a></li>
                                                <li><a href="MA-25.php">MA 25</a></li>
                                                <li><a href="MA-28.php">MA 28</a></li>
                                                <li><a href="MA-33.php">MA 33</a></li>
                                                <li><a href="MA-42.php">MA 42</a></li>
                                                <li><a href="PILOT-TEST.php">PILOT TEST</a></li>
                                                <li><a href="">TREMETRICS RA660</a></li>
                                            </ul>
                                        </li>
                                        <li class="menu-item-has-children">
                                            <a href="#">Tympanometers</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li><a href="">easyTymp Line</a></li>
                                                <li><a href="">touchTymp Line</a></li>
                                                <li><a href="">touchTymp Line</a></li>
                                            </ul>
                                        </li>
                                        <li class="menu-item-has-children">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li><a href="">easyScreen</a></li>
                                                <li><a href="">easyScreen BERAphone®</a></li>
                                                <li><a href="">MB 11 BERAphone®</a></li>
                                                <li><a href="">MB 11 Classic</a></li>
                                            </ul>
                                        </li>
                                        <li class="menu-item-has-children">
                                            <a href="#">OAE</a>
                                            <ul class="sub-menu">
                                                <li><a href="">ERO•SCAN</a></li>
                                                <li><a href="">easyScreen</a></li>
                                            </ul>
                                        </li>
                                        <li class="menu-item-has-children">
                                            <a href="#">Software & More</a>
                                            <ul class="sub-menu">
                                ...
                                <li class="menu-item-has-children">
                                    <a href="#">Equipment Repair & Service request</a>
                                    <ul class="sub-menu">
                                        <li class="menu-item-has-children">
                ...
                <div class="row">
                    <div class="col-lg-4 col-12">
                        <div class="header-top-left">
                            <p><span>Customer Service: </span> 9729746268</p>
                        </div>
                    </div>
                    <div class="col-lg-8 col-12">
                        <div class="box-right">
                            <ul>
                                ...
                                <li class="settings">
                                    <a href="#" class="drop-toggle">
                                        <span>INR <i class="fa fa-rupee"></i></span>
                                        <i class="fa fa-angle-down"></i>
                                    </a>
                                    <ul class="box-dropdown drop-dropdown">
                                        <li><a href="#">INR ₹ </a></li>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-6">
                        <div class="logo">
                            <a href="index.html"><img src="assets/images/audiology1.png" alt="" class="img-fluid"></a>
                        </div>
                    </div>
                        ...
                        <div class="categoryes-menu-bar">
                            ...
                            <nav class="categorye-menus category-dropdown">
                                <ul class="categories-expand">
                                    ...
                                    <li>
                                        <a href="#">easyTymp Line</a>
                                    </li>
                                    <li class="categories-hover-right">
                                        <a href="#">Audio Meter<i class="fa fa-angle-right float-right"></i></a>
                                        <ul class="cat-submenu category-mega">
                                            <li class="cat-mega-title"><a href="#"></a>
                                                <ul>
                                                    <li><a href="MA-1.php">MA 1</a></li>
                                                    <li><a href="MA-25.php">MA 25</a></li>
                                                    <li><a href="#">MA 28</a></li>
                                                    <li><a href="#">MA 33</a></li>
                                                    <li><a href="#">MA 42</a></li>
                                                </ul>
                                            </li>
                                    ...
                                    <li>
                                        <a href="#">TouchTymp RaceCar </a>
                                    </li>
                                    <li>
                                        <a href="#">easyScreen</a>
                                    </li>
                                    <li>
                                        <a href="#">easyScreen BERAphone®</a>
                                    </li>
                                    <li>
                                        <a href="#">MB 11 BERAphone®</a>
                                    </li>
                                    <li>
                                        <a href="#">ERO•SCAN</a>
                                    </li>
                                    <li>
                                        <a href="#">MB 11 Classic</a>
                                    </li>
                                    <li>
                                        <a href="#">Sessions</a>
                                    </li>
                                    ...
                                    <li class="category-item-parent">
                                        <a href="#" class="more-btn">MAXI 350  </a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
                            ...
                            <div class="sticky-container">
                                ...
                                <nav class="main-menu">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <div class="mega-menu dropdown">
                                                <ul class="mega-menu-inner d-flex">
                                                    ...
                                                    <li>
                                                        <a href="">Tympanometry</a>
                                                        <!-- <a href="">Other Pages</a> -->
                                                        <ul>
                                                            <li><a href="">EasyTymp Line</a></li>
                                                            <li><a href="">TouchTymp Line</a></li>
                                                            <li><a href="">TouchTymp RaceCar</a></li>
                                                            <br>
                                                            <h6><a href="">Oae</a></h6>
                                                        <!-- <a href="">Product Types</a> -->
                                                        <ul>
                                                            <li><a href="">ERo Scan</a></li>
                                                            <li><a href="">Easy Scan</a></li>
                                        ...
                                        <li>
                                            <a href="#">Equipment repair & Service request <i class="fa fa-angle-down"></i></a>
                                            <ul class="dropdown dropdown-width">
                                                <li>
                                                    <a href="">Calibration</a>
                                                    ...
                                                    <!-- <a href="blog-grid-right-sidebar.html">Electronic Item<i class="fa fa-angle-right float-right"></i></a>
                                                    <ul class="sub-dropdown dropdown dropdown-width">
                                                        <li><a href="blog-grid-right-sidebar.html">Right Sidebar</a></li>
                                                        <li><a href="blog-grid-left-sidebar.html">Left Sidebar</a></li>
                                                        <li><a href="blog-grid-fullwidth.html">Full Width</a></li>
                                                ...
                                                <li>
                                                    <a href="">Repair /Service</a>
                                                    <!-- <a href="blog-list-right-sidebar.html">Cloths<i class="fa fa-angle-right float-right"></i></a> -->
                                                    <!-- <ul class="sub-dropdown dropdown dropdown-width">
